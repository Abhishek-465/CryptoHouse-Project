...
const Filters = () => {
  ...
  const handleCurrencySubmit = (e) => {
    e.preventDefault();
    let val = currencyRef.current.value.trim(); // Trim whitespace
    if (val !== "") {
      setCurrency(val);
  ...
  return (
    <div
      ...
      hidden xl:flex xl:items-center xl:justify-between relative
    "
    >
      <Search />
     ...
     "
          />
          <button type="submit" className="ml-1 cursor-pointer" onClick={handleCurrencySubmit}>
