...
const PerPage = () => {
  ...
  return (
    <form
      className="relative flex items-center flex-col sm:flex-row font-nunito
          mr-4
          "
    ...
    >
      <label
        htmlFor="perpage"
        className="relative sm:flex justify-center items-center
          mr-2 font-bold hidden
          "
      >
        per page:{" "}
      </label>
     ...
     pl-2 required outline-0 border border-transparent hidden sm:inline-block
